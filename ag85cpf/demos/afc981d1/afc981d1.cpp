...
#include "..//..//libssrc//ag85cpfl//cpp1998//apfcol98//1//afclii98.hpp" //AG19850316CppframebraryPartCorelibrary1IncrementalIdGeneratorCpp1998
...
int main() {
    ...
    std::cout << "Incremental id generators values demo:" << std::endl;

    IncrementalIdGenerator<unsigned short> incrementalIdGroup1Generator(0);

    std::cout 
        << "incrementalIdGroup1Generator.GetNextId() returned "
        << incrementalIdGroup1Generator.GetNextId()
        << std::endl;

    IncrementalIdGenerator<unsigned long> incrementalIdGroup2Generator(1);

    std::cout 
        << "incrementalIdGroup2Generator.GetNextId() returned "
        << incrementalIdGroup2Generator.GetNextId()
        << std::endl;
